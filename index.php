...
<div id="y-content">
	...
	<?php elseif ( is_day() ): ?>
	<div class="mod">
		<h1 class="hd"><?php the_time('l, F jS, Y'); ?></h1>
	...
	<?php elseif ( is_month() ): ?>
	<div class="mod">
		<h1 class="hd"><?php the_time('F, Y'); ?></h1>
	...
	<div class="mod">
		<h1 class="hd"><?php echo bloginfo('name'); ?> Search: '<?php the_search_query(); ?>'</h1>
